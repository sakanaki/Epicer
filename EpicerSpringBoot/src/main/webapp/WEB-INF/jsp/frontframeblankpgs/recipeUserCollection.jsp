			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="list-inline dashboard-menu text-center">
						<li><a href="${pageContext.request.contextPath}/frontpartial">會員食譜</a></li>
						<li><a  class="active" href="/userCollection/1002">食譜收藏</a></li>
									...
									<c:forEach items="${userCollections }" var="item">
										<tr>
											...
											<td>
												...
												<a >
													<button type="button" class="btn btn-default" id="unlike">
