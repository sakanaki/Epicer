			...
			<div class="row">
				<div class="col-md-6">
					<ol class="breadcrumb">
						...
						<li><a href="555">課程</a></li>
						<li class="active"><%=theCourse.getCourseName()%></li>
					</ol>
				</div>
<!-- 				<div class="col-md-6"> -->
				...
				<div class="col-md-7">
					<div class="single-product-details">
						...
						<%
								...
								boolean allow = theCourse.getCourseDate()> today;
								if (allow == true ){
						%>
						<form ALIGN=center action="addcoursetocartpost" method="post">
						<input type="hidden" name="userId" value=1002> 
						<input type="hidden" name="courseId" value="<%=theCourse.getCourseId()%>"> 
						<input type="hidden" name="name" value="<%=theCourse.getCourseName()%>">
						<input type="hidden" name="price" value="<%=theCourse.getCoursePrice()%>">
						<input type="hidden" name="quantity" value=1>
						<button class="btn btn-main">點我報名</button>
						</form>
						<%} %>
					</div>
				</div>
